...
export default function AdminClicking() {
    ...
    function getCourse() {
        axios.get(`${process.env.NEXT_PUBLIC_SERVER_API}/course`, { headers: { 'secret': process.env.NEXT_PUBLIC_SECRET, 'type': 'clicking' } }).then(({ data }) => {
            setClicking(data)
        }).catch(err => {
            console.log(err)
        ...
        <>
            ...
            <AdminLayout name='course'>
                ...
                <Rodal visible={rodal} onClose={rodalClose}>
                    <h3>clicking bo'limiga darslik qo'shish</h3>
                            ...
                            <div className="video" onClick={() => videoRef.current.click()}>
                                ...
                                >
                                    <input
                                        ...
                                        type="file"
                                        ref={videoRef}
                                        onChange={({ clicking }) => setVideo(clicking.files[0])}
                                    />
                            ...
                            <div className="image" >
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        type="file"
                                        ref={photoRef}
                                        onChange={({ clicking }) => setPhoto(clicking.files[0])}
                                    />
                                </div>
                            </div>
                        </label>

        ...
        <>
            ...
            <AdminLayout name='course'>
                ...
                <Rodal visible={rodal} onClose={rodalClose}>
                    <h3>Insta daromad bo&#39;limiga darslik qo&#39;shish</h3>
                            ...
                            <div className="video" onClick={() => videoRef.current.click()}>
                                ...
                                >
                                    <input
                                        ...
                                        type="file"
                                        ref={videoRef}
                                        onChange={({ instagram }) => setVideo(instagram.files[0])}
                                    />
                            ...
                            <div className="image" >
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        type="file"
                                        ref={photoRef}
                                        onChange={({ instagram }) => setPhoto(instagram.files[0])}
                                    />
                                </div>
                            </div>
                        </label>
